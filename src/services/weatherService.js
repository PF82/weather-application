...
const getWeatherData = (infoType, searchParams) => {
    const url = new URL(process.env.REACT_APP_API_BASE_URL + "/" + infoType);
...
const formatCurrentWeather = (data) => {
    ...
    return { lat, lon, temp, feels_like, temp_min, temp_max, humidity, name, dt, country, sunrise, sunset, id, description, icon, speed };
}
